...
namespace QuantoCrypt.Internal.CipherSuite
{
    ...
    /// </remarks>
    public sealed class CrystalsKyber1024Aes_CrystalsDilithium5_AesGcm : ICipherSuite
    {
        public string Name => nameof(CrystalsKyber1024Aes_CrystalsDilithium5_AesGcm);
