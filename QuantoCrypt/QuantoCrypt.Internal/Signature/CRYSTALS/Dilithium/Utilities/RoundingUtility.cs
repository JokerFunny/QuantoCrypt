...
{
    /// <summary>
    /// Utility to perform rounding operations for Dilithium.
    /// </summary>
    internal class RoundingUtility
    {
        internal static int[] Power2Round(int a)
        {
            int[] r = new int[2];
        ...
        internal static int[] Decompose(int a, int gamma2)
        {
            int a0, a1;
            a1 = (a + 127) >> 7;
        ...
        internal static int MakeHint(int a0, int a1, DilithiumEngine engine)
        {
